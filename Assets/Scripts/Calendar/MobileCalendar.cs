...
public class MobileCalendar : MonoBehaviour
{
    ...
    public void OpenCalendar()
    {
        ...
        if (content.childCount == 0)
        {
            ...
            {
                if (item.Value.type == SpaceCalendar.SpaceType.Manana && GameManager.GetManager().dayNightCycle.DayState == DayNightCycle.DayState.Ma�ana)
                {
                    hora = DayNightCycle.DayState.Ma�ana;
