...
namespace FMOD.Studio
{
    ...
    public struct System
    {
        ...
        public RESULT getParameterLabelByName(string name, int labelindex, out string label)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                ...
                RESULT result = FMOD_Studio_System_GetParameterLabelByName(handle, nameBytes, labelindex, stringMem, 256, out retrieved);
        ...
        public RESULT getParameterLabelByID(PARAMETER_ID id, int labelindex, out string label)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                IntPtr stringMem = Marshal.AllocHGlobal(256);
                int retrieved = 0;
                RESULT result = FMOD_Studio_System_GetParameterLabelByID(handle, id, labelindex, stringMem, 256, out retrieved);
        ...
        public RESULT lookupPath(GUID id, out string path)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                IntPtr stringMem = Marshal.AllocHGlobal(256);
                int retrieved = 0;
                RESULT result = FMOD_Studio_System_LookupPath(handle, ref id, stringMem, 256, out retrieved);
        ...
        public RESULT loadBankMemory(byte[] buffer, LOAD_BANK_FLAGS flags, out Bank bank)
        {
            ...
            RESULT result = FMOD_Studio_System_LoadBankMemory(handle, pointer, buffer.Length, LOAD_MEMORY_MODE.LOAD_MEMORY, flags, out bank.handle);
            pinnedArray.Free();
            return result;
        }
        ...
        public RESULT getParameterDescriptionList(out PARAMETER_DESCRIPTION[] array)
        {
            ...
            int capacity;
            RESULT result = FMOD_Studio_System_GetParameterDescriptionCount(handle, out capacity);
            if (result != RESULT.OK)
            {
                return result;
            }
    ...
    public struct EventDescription
    {
        ...
        public RESULT getPath(out string path)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                IntPtr stringMem = Marshal.AllocHGlobal(256);
                int retrieved = 0;
                RESULT result = FMOD_Studio_EventDescription_GetPath(handle, stringMem, 256, out retrieved);
        ...
        public RESULT getParameterLabelByIndex(int index, int labelindex, out string label)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                IntPtr stringMem = Marshal.AllocHGlobal(256);
                int retrieved = 0;
                RESULT result = FMOD_Studio_EventDescription_GetParameterLabelByIndex(handle, index, labelindex, stringMem, 256, out retrieved);
        ...
        public RESULT getParameterLabelByName(string name, int labelindex, out string label)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                ...
                int retrieved = 0;
                byte[] nameBytes = encoder.byteFromStringUTF8(name);
                RESULT result = FMOD_Studio_EventDescription_GetParameterLabelByName(handle, nameBytes, labelindex, stringMem, 256, out retrieved);
        ...
        public RESULT getParameterLabelByID(PARAMETER_ID id, int labelindex, out string label)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                IntPtr stringMem = Marshal.AllocHGlobal(256);
                int retrieved = 0;
                RESULT result = FMOD_Studio_EventDescription_GetParameterLabelByID(handle, id, labelindex, stringMem, 256, out retrieved);
        ...
        public EventDescription(IntPtr ptr) { handle = ptr; }
        public bool hasHandle() { return handle != IntPtr.Zero; }
        public void clearHandle() { handle = IntPtr.Zero; }
    ...
    public struct EventInstance
    {
        ...
        public EventInstance(IntPtr ptr) { handle = ptr; }
        public bool hasHandle() { return handle != IntPtr.Zero; }
        public void clearHandle() { handle = IntPtr.Zero; }
    ...
    public struct Bus
    {
        ...
        public RESULT getPath(out string path)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                IntPtr stringMem = Marshal.AllocHGlobal(256);
                int retrieved = 0;
                RESULT result = FMOD_Studio_Bus_GetPath(handle, stringMem, 256, out retrieved);
        ...
        public Bus(IntPtr ptr) { handle = ptr; }
        public bool hasHandle() { return handle != IntPtr.Zero; }
        public void clearHandle() { handle = IntPtr.Zero; }
    ...
    public struct VCA
    {
        ...
        public RESULT getPath(out string path)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                IntPtr stringMem = Marshal.AllocHGlobal(256);
                int retrieved = 0;
                RESULT result = FMOD_Studio_VCA_GetPath(handle, stringMem, 256, out retrieved);
        ...
        public VCA(IntPtr ptr) { handle = ptr; }
        public bool hasHandle() { return handle != IntPtr.Zero; }
        public void clearHandle() { handle = IntPtr.Zero; }
    ...
    public struct Bank
    {
        ...
        public RESULT getPath(out string path)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                IntPtr stringMem = Marshal.AllocHGlobal(256);
                int retrieved = 0;
                RESULT result = FMOD_Studio_Bank_GetPath(handle, stringMem, 256, out retrieved);
        ...
        public RESULT getStringInfo(int index, out GUID id, out string path)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                IntPtr stringMem = Marshal.AllocHGlobal(256);
                int retrieved = 0;
                RESULT result = FMOD_Studio_Bank_GetStringInfo(handle, index, out id, stringMem, 256, out retrieved);
        ...
        public Bank(IntPtr ptr) { handle = ptr; }
        public bool hasHandle() { return handle != IntPtr.Zero; }
        public void clearHandle() { handle = IntPtr.Zero; }
    ...
    public struct CommandReplay
    {
        ...
        public RESULT getCommandString(int commandIndex, out string buffer)
        {
            ...
            using (StringHelper.ThreadSafeEncoding encoder = StringHelper.GetFreeHelper())
            {
                ...
                IntPtr stringMem = Marshal.AllocHGlobal(256);
                RESULT result = FMOD_Studio_CommandReplay_GetCommandString(handle, commandIndex, stringMem, stringLength);
        ...
        public CommandReplay(IntPtr ptr) { handle = ptr; }
        public bool hasHandle() { return handle != IntPtr.Zero; }
        public void clearHandle() { handle = IntPtr.Zero; }
